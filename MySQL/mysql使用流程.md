1. 以管理员权限进入cmd，cd C:\Programe Files\MySQL\MySQL Server 8.0\bin
2. 启动mysql服务net start mysqlzcx
3.进入mysql环境
法一：打开自带终端，输入密码即可；
法二：通过cmd，输入mysql -u root -p
密码：312312
4.进入mysql，所有命令最后必须加“;”除了exit
5.退出mysql环境命令：exit
6.在cmd中，关闭mysql服务：net stop mysqlzcx
